...
const BTC_ICON = `<svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M9.5 6v12"/><path d="M9.5 6h4.5a2.5 2.5 0 0 1 0 5H9.5"/><path d="M9.5 11h5a2.75 2.75 0 0 1 0 5.5H9.5"/><path d="M11.5 3.5V6M14.5 3.5V6M11.5 18v2.5M14.5 18v2.5"/></svg>`;
