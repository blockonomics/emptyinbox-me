...
server.tool(
  "list_messages",
  "List all received email messages, newest first. Optionally filter by inbox address.",
  {
    inbox: z
      .string()
      .optional()
...
server.tool(
  "wait_for_message",
  "Poll an inbox until a new message arrives. Use this after triggering an email verification, OTP, or signup confirmation — it will block and return the message as soon as it lands. Returns null if the timeout is reached.",
  {
